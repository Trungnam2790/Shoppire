    ...
    <section className="max-padd-container py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 bg-white rounded-xl">
        <div className="p-4 rounded-3xl text-center">
          <TbArrowBackUp className="bold-32 mb-3 text-yellow-500 mx-auto" size={40}/>
         ...
         <div className="p-4 rounded-3xl text-center">
          <TbTruckDelivery className="bold-32 mb-3 text-secondary mx-auto" size={40}/>
          <h4 className="h4 capitalize">Fast Delivery</h4>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis tenetur dolorem alias illum perspiciatis animi?</p>
         </div>
         <div className="p-4 rounded-3xl text-center">
          <RiSecurePaymentLine className="bold-32 mb-3 text-red-500 mx-auto" size={40}/>
