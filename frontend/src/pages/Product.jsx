    ...
    <section>
      <div className='max-padd-container mt-8 xl:mt-6'>
        ...
        <div className='max-padd-container flex gap-12 flex-col xl:flex-row bg-white py-16 rounded-2xl'>
          ...
          {/* product info */}
          <div className='flex-[1.5] rounded-2xl scroll-px-7'>
            ...
            <div className='flex items-center gap-x-4'>
              <button onClick={() => addToCart(product._id, size)} className='btn-dark w-1/2 flex items-center justify-center gap-x-2 capitalize'>Add to cart <TbShoppingBagPlus/></button>
